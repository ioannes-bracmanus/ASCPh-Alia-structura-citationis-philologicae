...
El documento con la estructura y justificación se compuso con la fuente [AltStandard](https://github.com/ioannes-bracmanus/AltStandard.git). El código en los archivos .bbx, .blx, .cbx y .dbx fue producido con asistencia de IA, a partir de indicaciones específicas del diseño técnico del sistema de citación. Para usar el sistema al componer en LaTeX debe copiarse el contenido en «package source» y ubicarse en la carpeta del trabajo (que contiene los archivos .tex y .bib): en caso de usar un ecosistema Linux, puede instalarse en una ruta en «home» que simule la instalación en sistema, y puede hacerlo con «mkdir -p ~/texmf/tex/latex/biblatex/nphc» (omítase las comillas). En caso de usar procesadores de texto como Microsoft Office, basta con seguir la estructura a rellenar expuesta en el documento .pdf. 
